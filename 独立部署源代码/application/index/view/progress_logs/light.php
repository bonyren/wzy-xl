<table id="progressLogsDatagrid_<?=$uniqid?>" class="easyui-datagrid" data-options="striped:true,
    ...
    <tr>
        <?php if(!$readOnly){ ?>
        <th data-options="field:'operate',width:100,fixed:true,align:'center',formatter:progressLogsModule_<?=$uniqid?>.operate">操作</th>
        <?php } ?>
...
var progressLogsModule_<?=$uniqid?> = {
    ...
    add:function(){
        ...
        QT.helper.dialog('添加',href,true,function($dialog){
