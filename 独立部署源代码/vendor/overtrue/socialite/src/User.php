...
class User implements ArrayAccess, UserInterface, JsonSerializable, \Serializable
{
    ...
    public function setSnapshotuser($snapshotuser){
        $this->setAttribute('is_snapshotuser', $snapshotuser);
        return $this;
    }
    public function getSnapshotuser(){
        return $this->getAttribute('is_snapshotuser');
    }
