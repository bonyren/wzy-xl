...
var index$2 = require('./index-BzEyuIww.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (!index.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-bGpoPC4u.js'); }).then((module) => module.startTapClick(index.config));
                }
                if (index.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-D9YPr62n.js'); }).then((module) => module.startStatusTap());
                }
                if (index.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-CLI_OrmU.js'); }).then((module) => module.startInputShims(index.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-BxdNu76F.js'); });
